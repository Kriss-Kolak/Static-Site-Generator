...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for content_object in folder_content:
        ...
        if os.path.isfile(content_object_src_path) and content_object.endswith(".md"):
            ...
            generate_page(content_object_src_path, template_path, content_object_dest_path)
            ...
            generate_pages_recursive(content_object_src_path, template_path, content_object_dest_path)
